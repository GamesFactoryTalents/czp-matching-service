...
def match_batch(
    ...
    for cand in req.candidates:
        single_req = MatchRequest(
            ...
            job_country=req.job_country,
            job_city=req.job_city,
            job_seniority=req.job_seniority,
            job_salary_min=req.job_salary_min,
            job_salary_max=req.job_salary_max,
            job_art_styles=req.job_art_styles,
            job_platforms=req.job_platforms,
            job_engines=req.job_engines,
            job_genres=req.job_genres,
            # Candidate fields
            current_job_title=cand.get("current_job_title"),
            category=cand.get("category"),
            seniority=cand.get("seniority"),
            experience_years=cand.get("experience_years"),
            years_in_gaming=cand.get("years_in_gaming"),
            location=cand.get("location"),
            attendance_mode=cand.get("attendance_mode"),
            is_open_to_relocation=cand.get("is_open_to_relocation"),
            ...
            art_styles=cand.get("art_styles", []),
            employment_types=cand.get("employment_types", []),
            work_preferences=cand.get("work_preferences", []),
            game_titles=cand.get("game_titles"),
            tasks_and_responsibilities=cand.get("tasks_and_responsibilities"),
            motivation=cand.get("motivation"),
            expectations=cand.get("expectations"),
            dream_job=cand.get("dream_job"),
