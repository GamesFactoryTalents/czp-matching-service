...
{{
  ...
  "recruiter_brief": "<For Shortlist/Review only: 3-5 sentences written directly to the recruiter, explaining why this candidate is worth contacting, what to focus on in the conversation, and what logistics to confirm (availability, salary, notice period). Be specific and actionable — reference the candidate's actual background. For Pass candidates: empty string.>"
}}
