...
{{
  ...
  "recruiter_brief": "<For Shortlist/Review only: a structured explanation of why the candidate received this score — what matched and what did not. Use the section headers exactly as shown below. Each section should be 1-3 sentences. For Pass candidates: empty string.\n\n**Seniority:** State the candidate's self-reported seniority level and whether it matches, exceeds, or falls short of what the job requires. If the CV confirms or contradicts the self-reported level, note it.\n\n**Skills & Specialities:** Name the specific skills and specialisations that align with the job requirements, then identify the primary gap. Be concrete — name the technologies, not just 'strong match'.\n\n**Salary:** Only include this section if BOTH the job salary range AND the candidate's expected salary are provided — state both figures and whether they align or show a gap. If either is missing, omit this section entirely — do not write the header, do not mention salary at all.\n\n**Location:** State the candidate's location and the job location. If they match, confirm briefly. If they differ, note the gap.\n\n**Relocation:** Only include this section if the candidate's location differs from the job location AND the job requires onsite or hybrid work. State whether the candidate is open to relocation. If the job is remote or the locations already match, omit this section.\n\n**Employment Type:** State the candidate's preferred employment type (Full-time, Part-time, Freelance, Contract, etc.) and whether it matches what the job offers. If employment preference is not specified by the candidate, note it is not stated.\n\n**Gaming Experience:** Only include this section if the job is in the gaming industry. State whether the candidate has relevant gaming industry experience — cite shipped titles, studio names, or years in gaming from the CV. If no gaming experience is evident, flag it as a gap.>"
}}
